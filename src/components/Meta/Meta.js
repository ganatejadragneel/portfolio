...
const name = 'Gana Teja Akula';
const linkedinHandle = '@gantejadragneel';
...
export const Meta = ({ title, description, prefix = name, ogImage = defaultOgImage }) => {
  ...
  return (
    <Head>
      ...
      <meta name="twitter:site" content={linkedinHandle} />
      <meta name="twitter:creator" content={linkedinHandle} />
